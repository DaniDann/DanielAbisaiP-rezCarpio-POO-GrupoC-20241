...
public class Libreria {
    ...
    public Libreria () {
        Asistente asistente = new Asistente("joshi", "durango", "443789767", 1900, "DURAN13442", "duro34", "12345");
        usuarios.add(asistente);

        Gerente gerente = new Gerente("kiker", "cholis", "4435689076", "KIKIS2445", 14500, "kiki4568", "13456");
        usuarios.add(gerente);

        Cliente cliente = new Cliente("camaron", "atapanes", "44356787", "CAMA12355", "5647");
