...
public class DatosComun {
    ...
    private static String registrarTelefonoUsuario() {
        ...
        do {
            ...
            if (telefonoExistente) {
                System.out.println("Ese telefono ya se encuentra registrado. Intenta de nuevo");
            }
    ...
    private static String registrarNombreUsuario() {
        ...
        do {
            ...
            if (nombreUsuarioExistente) {
                System.out.println("Ese nombre de usuario ya se encuentra registrado. Intenta de nuevo");
            }
    ...
    private static String registrarFechaNacimiento(){
        ...
        do {
            System.out.println("Ingrese la fecha de nacimiento de la siguiente manera(dd/MM/yyyy):");
            ...
            if (!fechaEsValida(fechaNacimiento)) {
                System.out.println("La fecha de nacimiento inválida. Intente nuevamente.");
            }
