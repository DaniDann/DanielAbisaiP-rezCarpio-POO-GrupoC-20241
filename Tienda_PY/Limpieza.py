...
class Limpieza(Producto):
  def __init__(self, nombre, precio, fechaImportacion, numeroSerie, esBiodegradable):
    super().__init__(nombre, precio, fechaImportacion, numeroSerie)
    self.esBiodegradable = esBiodegradable